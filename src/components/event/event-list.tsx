...
export default function EventList() {
    ...
    const createEvent = async () => {
        ...
        try {
            ...
            formData.append("date", newEvent.date) // ou new Date(...).toISOString()
            formData.append("maxParticipants", String(newEvent.max_participants)) // ✅ Casing important
            ...
            toast({
                ...
                description: `L'événement "${response.data.title}" a été ajouté.`,
            })
